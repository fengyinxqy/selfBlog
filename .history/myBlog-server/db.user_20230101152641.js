 ...
 * @Date: 2023-01-01 15:19:58
 * @LastEditors: Petrichor 572752189@qq.com
 * @LastEditTime: 2023-01-01 15:26:40
 * @FilePath: \项目_肖祺彦_2022.12.21.36\myBlog-server\db.user.js
 * @Description: 
 * 
...
Article.create({
  title: "测试文章1",
  body: articleBody,
  author: mongoose.Types.ObjectId('5fd76f7515c5203c44a8add9'),
}).then(doc => {
  console.log(doc)
}).catch(err => {
  console.log('错误 ---------------------')
