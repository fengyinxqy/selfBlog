 ...
 * @LastEditTime: 2023-01-16 16:05:15
...
router.post('/:classify', async (req, res, next) => {
  ...
  try {
    ...
    if (classify === 'login') {
      ...
      console.log(decrypt(password), decrypt('X5w1xKyXdpQZq8YRF6uk0BaVoBp0FNrU1fUnl6wx1sb+B1Q+LL8mj+nw6s5zy7ZWH1akHX4qWRwOGa6j+QMvJQ=='), 'decrypt')
      console.log(assert.equal(decrypt(password), decrypt(decrypt(user.password)))
