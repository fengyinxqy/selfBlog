...
router.post('/:classify', async (req, res, next) => {
  ...
  try {
    ...
    if (classify === 'login') {
      ...
      console.log(decrypt(password), decrypt('InkFBO6KITDATbQTgs2hilSN4NrFkzRq0I5DEeLYsuMFINKhh0tHZxXQ4m+JGbBwG+wI9DTlMfKcR5AJ/GGuE2SEUUhFr85HznwbyC9/qZPVbA=='), 'decrypt')
