 ...
 * @LastEditTime: 2023-01-16 20:38:02
...
import artical from '../src/views/article.hbs'
import artical from '../src/views/articles.hbs'
import message from '../src/views/message.hbs'
import $ from 'jquery'


const TEMP_MAP = {
  head, user, modal, write, artical, message
}
